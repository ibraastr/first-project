...
function handleDigitClick(event) {
  ...
  popupImgText.textContent = event.target.closest('.place').textContent;
  console.log(popupImgText.textContent);
}


//функция - "обработать форму профиля Отправить" - для сохранения значений из полей формы при нажатии кнопки "сохранить"
